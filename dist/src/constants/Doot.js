...
import { SmartContract, Field, method, State, state, PublicKey, Signature, Experimental, Struct, Provable, } from 'o1js';
...
export class Doot extends SmartContract {
    ...
    async initBase(updatedCommitment, updatedIpfsCID, informationArray) {
        ...
        const lastPriceInformation = await this.offchainState.fields.tokenInformation.get(Field(0));
...
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Signature,
        PublicKey,
        Field]),
    __metadata("design:returntype", Promise)
